...
Scene* PauseResumeMenu::createScene()
{
    auto scene = Scene::create();
    
    auto layer = PauseResumeMenu::create();
...
bool PauseResumeMenu::init()
{
    ...
    auto playItem = MenuItemFont::create( "Resume", CC_CALLBACK_1( PauseResumeMenu::Resume, this ) );
    auto highscoresItem = MenuItemFont::create("Highscores", CC_CALLBACK_1( PauseResumeMenu::Highscores, this ) );
    auto settingsItem = MenuItemFont::create("Settings", CC_CALLBACK_1( PauseResumeMenu::Settings,this ) );
    auto exitGame = MenuItemFont::create("Exit", CC_CALLBACK_1(PauseResumeMenu::ExitGame, this) );
...
void PauseResumeMenu::Resume( Ref *sender )
{
    Director::getInstance( )->popScene( );
}

void PauseResumeMenu::Highscores( Ref *sender )
{
...
void PauseResumeMenu::Settings( Ref *sender )
{
    CCLOG("SETTINGS");
}

void PauseResumeMenu::ExitGame( Ref *sender )
{
    Director::getInstance()->end();
    exit(TRANSITION_TIME * 3);
}

void PauseResumeMenu::update(float dt)
{
